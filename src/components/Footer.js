      ...
      <footer className="footer">
         <div className="container-fluid">
            <div className="row">
               <div className="col-lg-4 d-flex align-items-center justify-content-center">
                  <div className="footer__contact">
                     ...
                     <ul>
                        ...
                        <li><CallIcon /><h3>0551 746 23 26</h3></li>
                        <li><AlternateEmailIcon /><h3>markabaklava@gmail.com</h3></li>
                     </ul>
                  </div>
               </div>
               ...
               <div className="col-lg-4 mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
                  <div className="footer__misc">
                     ...
                     <img className="footer__misc_quality" src={process.env.PUBLIC_URL + '/img/quality.png'} alt="Guvenli Alisveris" />
                  </div>
               </div>
